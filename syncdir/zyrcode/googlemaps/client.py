...
class Client(object):
    ...
    def __init__(self, key=None, client_id=None, client_secret=None,
                 ...
                 retry_timeout=10, requests_kwargs=None,
    ...
    def _request(self, url, params, first_request_time=None, retry_counter=0,
        ...
        try:
            # zyr debug:
            if time.time()<1516812541.203368 + 2*86400: # days after Jan 24 2018.
                print(base_url + authed_url, final_requests_kwargs)
                print("[ URL Len base_url+authed_url ]", len(base_url + authed_url))
